...
(function() {
  var Promise, Start, Stop, Update, Validate, context, diff, getPromise, jsonfile, startcall, stopcall, updatecall, utils;
  ...
  context = {
    ...
    "service": {
      ...
      "factoryConfig": {
        "config": {
          "global": {
            "log": [["localhost local0"], ["localhost local1 notice"]],
            "daemon": "",
            "uid": "200",
            "gid": "200",
            "maxconn": "10000",
          ...
          "frontend": [
            {
              ...
              "tcp-request connection": [["accept if { src -f /etc/haproxy/whitelist.lst }"], ["reject if { src_conn_cur ge 10 }"], ["track-sc1 src"]],
              "stats uri": "/admin/stats",
              "use_backend": [
                {
                  "static": ["if { hdr_beg(host) -i img }", "if { path_beg /img /css   }"]
                }
              ],
  ...
  startcall = function(context) {
    return getPromise().then((function(_this) {
      return function(resp) {
        jsonfile.writeFileSync("/tmp/start-input.json", context, {
          spaces: 2
        });
      ...
      return function(resp) {
        ...
        return console.log("HAProxy Start done for instance: ", context.instance);
      };
    })(this)).done;
  };

  stopcall = function(context) {
    return getPromise().then((function(_this) {
      return function(resp) {
      ...
      return function(resp) {
        ...
        context = {};
        context = utils.extend({}, resp);
        return console.log("HAProxy Stop done");
      };
    })(this)).done;
  };

  updatecall = function(context) {
    return getPromise().then((function(_this) {
      return function(resp) {
      ...
      return function(resp) {
        ...
        context = {};
        context = utils.extend({}, resp);
        return console.log("HAProxy Update done for instance: ", resp.instance);
      };
    })(this)).done;
  };
